...
namespace Sample.Core.XUnit.Nuget.Tests.Views;

public class AllUsersTests7 : XUnitBase
{
    [Fact]
    public async Task AllUsers_NoData_NothingReturned()
    {
        ...
        Assert.Equal(0, await TestRunner.CountRowsInViewAsync("dbo.AllUsers"));
    }
    ...
    public async Task AllUsers_OneRow_OneUserReturned()
    {
        ...
        Assert.Equal(1, await TestRunner.CountRowsInViewAsync("dbo.AllUsers"));
    }
