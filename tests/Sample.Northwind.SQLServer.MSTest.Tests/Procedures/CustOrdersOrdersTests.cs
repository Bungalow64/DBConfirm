...
using Sample.SQLServer.Northwind.MSTest.Tests.Templates;
using DBConfirm.Core.Data;
using DBConfirm.Core.DataResults;
using DBConfirm.Packages.SQLServer.MSTest;
using System;
using System.Threading.Tasks;
using Sample.SQLServer.Northwind.MSTest.Tests.Templates.Complex;

namespace Sample.SQLServer.Northwind.MSTest.Tests.Procedures
{
    [TestClass]
