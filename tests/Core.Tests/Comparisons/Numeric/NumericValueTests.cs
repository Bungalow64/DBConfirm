...
public class NumericValueTests
{
    ...
    {
        NumericValue numericValue = new(123);
    ...
    {
        NumericValue numericValue = new((short)20);
    ...
    {
        NumericValue numericValue = new(20L);
    ...
    {
        NumericValue numericValue = new(20M);
        Assert.AreEqual(20L, numericValue.ExpectedValue);
    }
    ...
    {
        NumericValue numericValue = new(10D);
    ...
    {
        NumericValue numericValue = new(10F);
        Assert.AreEqual(10D, numericValue.ExpectedValue);
    }
    ...
    {
        NumericValue numericValue = new((byte)10);
    ...
    {
        NumericValue numericValue = new(10);
    ...
    {
        NumericValue numericValue = new(value);
    ...
    {
        NumericValue numericValue = new(expectedValue);
