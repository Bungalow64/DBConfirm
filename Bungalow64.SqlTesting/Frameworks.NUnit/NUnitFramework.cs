...
using FrameworkAssert = NUnit.Framework;
...
namespace Frameworks.NUnit
{
    public class NUnitFramework : ITestFramework
    {
        ...
        {
            FrameworkAssert.StringAssert.IsMatch(pattern.ToString(), value, message, parameters);
        }

        public void DoesNotMatch(string value, Regex pattern, string message, params string[] parameters)
        {
            FrameworkAssert.StringAssert.DoesNotMatch(pattern.ToString(), value, message, parameters);
        }
        ...
        {
            FrameworkAssert.Assert.IsInstanceOf(expectedType, value, message, parameters);
        }
