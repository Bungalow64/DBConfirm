...
namespace Models.Tests.Validation
{
    ...
    public class ValueValidationTests
    {
        ...
        {
            Assert.DoesNotThrow(() => ValueValidation.Validate(expectedValue, actualValue, "Custom assertion"));
        }
        ...
        public void ValueValidation_Validate_BasicObjects_AreNotEqual(object expectedValue, object actualValue)
        {
            var exception = Assert.Throws<Microsoft.VisualStudio.TestTools.UnitTesting.AssertFailedException>(() => 
                ValueValidation.Validate(expectedValue, actualValue, "Custom assertion"));
        ...
        {
            Assert.DoesNotThrow(() => ValueValidation.Validate(null, DBNull.Value, "Custom assertion"));
        }

        [Test]
        public void ValueValidation_Validate_ExpectDBNullActualNull_AreEqual()
        {
            Assert.DoesNotThrow(() => ValueValidation.Validate(DBNull.Value, null, "Custom assertion"));
        }

        [Test]
        public void ValueValidation_Validate_ExpectDBNull_AreEqual()
        {
            Assert.DoesNotThrow(() => ValueValidation.Validate(DBNull.Value, DBNull.Value, "Custom assertion"));
        }
        ...
        {
            var exception = Assert.Throws<Microsoft.VisualStudio.TestTools.UnitTesting.AssertFailedException>(() => 
                ValueValidation.Validate("123", 123, "Custom assertion"));
        ...
        public void ValueValidation_Validate_AssertState_AreNotEqual_ThrowError()
        {
            ...
            state
                .Setup(p => p.AssertState(It.IsAny<object>(), It.IsAny<string>()))
                .Callback<object, string>((p, q) =>
                {
                    requestedValue = p;
                    requestedMessage = q;
                })
            ...
            Assert.Throws<Microsoft.VisualStudio.TestTools.UnitTesting.AssertFailedException>(() => 
                ValueValidation.Validate(state.Object, "ValueA", "Custom assertion"));

            state
                .Verify(p => p.AssertState(It.IsAny<object>(), It.IsAny<string>()), Times.Once);
        ...
        public void ValueValidation_Validate_AssertDate_AreNotEqual_ThrowError()
        {
            ...
            state
                .Setup(p => p.AssertDate(It.IsAny<DateTime>(), It.IsAny<string>()))
                .Callback<DateTime, string>((p, q) =>
                {
                    requestedValue = p;
                    requestedMessage = q;
                })
            ...
            Assert.Throws<Microsoft.VisualStudio.TestTools.UnitTesting.AssertFailedException>(() =>
                ValueValidation.Validate(state.Object, DateTime.Parse("01-Mar-2020"), "Custom assertion"));

            state
                .Verify(p => p.AssertDate(It.IsAny<DateTime>(), It.IsAny<string>()), Times.Once);
        ...
        public void ValueValidation_Validate_AssertDate_ActualValueNotADate_ThrowError()
        {
            ...
            var exception = Assert.Throws<Microsoft.VisualStudio.TestTools.UnitTesting.AssertFailedException>(() =>
                ValueValidation.Validate(state.Object, 123, "Custom assertion"));

            state
                .Verify(p => p.AssertDate(It.IsAny<DateTime>(), It.IsAny<string>()), Times.Never);
        ...
        public void ValueValidation_Validate_AssertString_AreNotEqual_ThrowError()
        {
            ...
            state
                .Setup(p => p.AssertString(It.IsAny<string>(), It.IsAny<string>()))
                .Callback<string, string>((p, q) =>
                {
                    requestedValue = p;
                    requestedMessage = q;
                })
            ...
            Assert.Throws<Microsoft.VisualStudio.TestTools.UnitTesting.AssertFailedException>(() =>
                ValueValidation.Validate(state.Object, "ABC", "Custom assertion"));

            state
                .Verify(p => p.AssertString(It.IsAny<string>(), It.IsAny<string>()), Times.Once);
        ...
        public void ValueValidation_Validate_AssertString_ActualValueNotAString_ThrowError()
        {
            ...
            state
                .Verify(p => p.AssertString(It.IsAny<string>(), It.IsAny<string>()), Times.Never);
