...
namespace DBConfirm.Databases.SQLServer.Extensions
{
    ...
    {
        /// <summary>
        /// Converts an <see cref="IDictionary{TKey, TValue}"/> to an IList of <see cref="SqlParameter"/> objects.  The Key is used as the column name, and the Value the parameter value
        /// </summary>
        ...
        /// <returns>Returns an IList of <see cref="SqlParameter"/> objects</returns>
        public static IList<SqlParameter> ToSqlParameters(this IDictionary<string, object> dictionary, string tableName)
        {
            ...
            return dictionary.Select(p => new SqlParameter($"@{p.Key}", getValue(p))).ToList();
        }
        ...
        /// <param name="dictionary">The dictionary to convert.  A null or empty dictionary results in an empty array</param>
        /// <returns>Returns an IList of <see cref="SqlParameter"/> objects</returns>
        public static IList<SqlParameter> ToSqlParameters(this IDictionary<string, object> dictionary)
        {
